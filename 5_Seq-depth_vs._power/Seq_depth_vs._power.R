...
#
# Seq-depth vs. power 
#   1,3,5,10 SNP over 1k transcript
#   seq-depth 30X, 50X, 100X
#   
#
################################################################################
...
#####################################################################################
###                                                                               ###
### determine the Seq-depth vs. power                                             ###
###   1 SNP over 1k transcript                                                    ###
###   seq-depth 30X, 50X, 100X                                                    ###
###                                                                               ###
#####################################################################################
...
Power_vs_seq_depth <- cbind(paras,FDR_True_A, Power_True_B,
                            ...
                            Power_Prop_B_GTA, Power_Prop_B_GTB, 
                            FDR_Summ_A, Power_Summ_B,
                            adj_FDR_True_A, adj_Power_True_B, 
                            adj_FDR_GSE_A_GTA, adj_FDR_GSE_A_GTB, 
                            adj_Power_GSE_B_GTA, adj_Power_GSE_B_GTB,
                            adj_FDR_Even_A_GTA, adj_FDR_Even_A_GTB,
...
rm(list=setdiff(ls(),"Power_vs_seq_depth"))
save.image("Power_vs_seq_depth.RData")
